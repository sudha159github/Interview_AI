...
public class AuthController(AuthService authService, ICurrentUser currentUser) : ControllerBase
{
    ...
    private ObjectResult ToProblem(AuthResult result)
    {
        ...
        {
            AuthErrorType.Conflict => (StatusCodes.Status409Conflict, "Account already exists"),
            AuthErrorType.InvalidCredentials => (StatusCodes.Status401Unauthorized, "Login failed"),
